        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/available" className="text-white/50 hover:text-[#D52E28] transition-colors">Available Listings</Link></li>
              ...
              <li><Link href="/guides" className="text-white/50 hover:text-[#D52E28] transition-colors">Free Guides</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                ...
                >
                  <svg className="w-4 h-4 text-[#D52E28]" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 11v2.4h6.835c-.273 1.748-2.043 5.121-6.835 5.121-4.114 0-7.473-3.408-7.473-7.61s3.359-7.61 7.473-7.61c2.342 0 3.91.999 4.806 1.857l3.276-3.157C18.018 1.083 15.319 0 12 0 5.366 0 0 5.366 0 12s5.366 12 12 12c6.926 0 11.523-4.87 11.523-11.722 0-.788-.085-1.39-.19-1.988H12z"/>
                  </svg>
                  Google Reviews
                </a>
              </li>
