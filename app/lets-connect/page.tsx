  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-[40vh] flex items-center justify-center">
        <Image
          src="https://images.squarespace-cdn.com/content/v1/65abf6f1bf81c02e7cbd3cb1/1705881243283-RTAKWUATU67MZF7SM5RY/image-asset.jpeg"
          alt="Let's Connect"
          fill
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:4692561088" className="font-medium text-lg hover:text-gray-600">
                      (469) 256-1088
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:colin@hugginsrealty.com" className="font-medium text-lg hover:text-gray-600">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="https://www.instagram.com/bundlbook/" target="_blank" rel="noopener noreferrer" className="font-medium text-lg hover:text-gray-600">
                      @bundlbook
                    </a>
                  </div>
                </div>
