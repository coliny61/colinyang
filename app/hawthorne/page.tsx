  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('/images/hawthorne/backyard.jpeg')] bg-cover bg-center opacity-10" />
        <div className="relative max-w-3xl mx-auto px-6 py-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/lease-inquiry?property=2315-hawthorne"
              className="btn-white"
            >
              Apply Now
            </Link>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <Link href="/lease-inquiry?property=2315-hawthorne" className="btn-secondary !py-3 !px-5 !border-[#D52E28] !text-[#D52E28]">
                    Apply Now
                  </Link>
                </div>
              </div>
